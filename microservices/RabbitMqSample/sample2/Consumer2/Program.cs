...
await channel.QueueDeclareAsync(queue: "sample2_queue2",
    durable: false,
    exclusive: false,
    autoDelete: false,
    arguments: null).ConfigureAwait(false);
await channel.QueueBindAsync(queue: "sample2_queue2",
    exchange: "sample2",
...
await channel.BasicConsumeAsync(queue: "sample2_queue2",
    autoAck: true,
